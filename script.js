...
await browser.wait(wd.until.elementLocated(wd.By.css("#innings_3 .cb-col.cb-col-100.cb-ltst-wgt-hdr")));
let tables = await browser.findElements(wd.By.css("#innings_3 .cb-col.cb-col-100.cb-ltst-wgt-hdr"));
